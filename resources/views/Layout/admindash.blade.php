...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets4/css/vendor/fullcalendar.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets4/css/vendor/dataTables.bootstrap4.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets4/css/vendor/datatables.responsive.bootstrap4.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets4/css/vendor/select2.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets4/css/vendor/select2-bootstrap.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets4/css/vendor/perfect-scrollbar.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets4/css/vendor/glide.core.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets4/css/vendor/bootstrap-stars.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets4/css/vendor/nouislider.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets4/css/vendor/bootstrap-datepicker3.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets4/css/vendor/component-custom-switch.min.css') }}" />
...
<body id="app-container" class="menu-default ">
    ...
    <script src="{{ asset('assets4/js/vendor/Chart.bundle.min.js') }}"></script>
    <script src="{{ asset('assets4/js/vendor/chartjs-plugin-datalabels.js') }}"></script>
    <script src="{{ asset('assets4/js/vendor/moment.min.js') }}"></script>
    <script src="{{ asset('assets4/js/vendor/fullcalendar.min.js') }}"></script>
    <script src="{{ asset('assets4/js/vendor/datatables.min.js') }}"></script>
    <script src="{{ asset('assets4/js/vendor/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ asset('assets4/js/vendor/glide.min.js') }}"></script>
    <script src="{{ asset('assets4/js/vendor/progressbar.min.js') }}"></script>
    <script src="{{ asset('assets4/js/vendor/jquery.barrating.min.js') }}"></script>
    <script src="{{ asset('assets4/js/vendor/select2.full.js') }}"></script>
    <script src="{{ asset('assets4/js/vendor/nouislider.min.js') }}"></script>
    <script src="{{ asset('assets4/js/vendor/bootstrap-datepicker.js') }}"></script>
    <script src="{{ asset('assets4/js/vendor/Sortable.js') }}"></script>
    <script src="{{ asset('assets4/js/vendor/mousetrap.min.js') }}"></script>
