...
<div class="mt-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        {{-- #7 --}}
        <div class="w-full px-4 sm:px-16 xl:px-32">
            <p class="italic text-base pt-16">BERITA ADAM...</p>
            <p class="font-semibold text-3xl">Ikut keseharian Adam Dustin</p>
            <p class="bg-black w-20 mt-3 h-1 rounded-lg"></p>
            <div class="flex flex-wrap justify-center gap-x-10 mb-10">
                <a href="" class="mt-10 relative overflow-hidden rounded-md shadow-md w-80 lg:w-96 xl:w-[550px] scale-100 hover:scale-105 transition ease-in-out duration-200">
                    <div>
                        ...
                        <div class="absolute bg-gradient-to-t from-gray-800 opacity-80 text-white p-2 bottom-0">
                            <p class="text-xs lg:text-base max-w-20 text-center rounded-sm px-2 p-1 text-black bg-white">Inspirasi</p>
                            <p class="font-bold text-sm lg:text-lg">Specta ITK 2024: Adam Dustin Bhakti Berbagi Inspirasi Kewirausahaan dan Inovasi Berkelanjutan</p>
                            <p class="font-thin text-xs lg:text-sm">Adam Dustin Bhakti (kedua dari kanan) usai mengisi materi di Specta ITK 2024. (Foto: Istimewa)</p>
                        </div>
                    </div>
                </a>
                <a href="" class="mt-10 relative overflow-hidden rounded-md shadow-md w-80 lg:w-96 xl:w-[550px] scale-100 hover:scale-105 transition ease-in-out duration-200">
